...
% SOURCE: https://www.mathworks.com/help/mpc/ug/control-of-quadrotor-using-nonlinear-model-predictive-control.html
...
syms k l m b g u1 u2 u3 u4 r1 r2 r3 n1 n2 n3

% Linear disturbance vector
r = [r1; r2; r3];
% Angular disturbance vector
n = [n1; n2; n3];
...
f = [ % Set time-derivative of the positions and angles
      ...
      -g*[0;0;1] + R*[0;0;T]/m + R*r/m;

      % Euler–Lagrange equations for angular dynamics
      inv(J)*(tau_beta - C*state(10:12) + n)
];
