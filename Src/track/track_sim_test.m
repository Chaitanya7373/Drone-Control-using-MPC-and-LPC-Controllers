...
[q,qd,qdd,qddd,qdddd,pp,tPoints,tSamples] = minsnappolytraj([start final], [0 tf], tf/dt);
% plot3(q(1,:), q(2,:), q(3,:));
% axis equal
% plot(tSamples, qd(1,:), tSamples, qd(2,:), tSamples, qd(3,:));
ctrl = track_controller(quad, q, qd, qdd, tSamples, dt);
